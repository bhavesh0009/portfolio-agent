...
IMPORTANT: All screening results include auto-enriched Symbol and Exchange fields:
  - Symbol: Correct ticker symbol for Yahoo Finance (e.g., "SHILCTECH", "RELIANCE")
  - Exchange: NSE or BSE
  - ALWAYS reference these fields in your final answer - they are authoritative for portfolio tracking
